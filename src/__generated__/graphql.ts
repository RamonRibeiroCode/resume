...
export type FindMeLink = Node & {
  __typename?: 'FindMeLink';
  /** The time the document was created */
  createdAt: Scalars['DateTime'];
  /** User that created this document */
  createdBy?: Maybe<User>;
  /** Get the document in other stages */
  documentInStages: Array<FindMeLink>;
  /** List of FindMeLink versions */
  history: Array<Version>;
  href: Scalars['String'];
  /** The unique identifier */
  id: Scalars['ID'];
...
export type FindMeLinkCreatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
  locales?: InputMaybe<Array<Locale>>;
};


export type FindMeLinkDocumentInStagesArgs = {
  includeCurrent?: Scalars['Boolean'];
  inheritLocale?: Scalars['Boolean'];
  stages?: Array<Stage>;
};
...
export type FindMeLinkHistoryArgs = {
  limit?: Scalars['Int'];
  skip?: Scalars['Int'];
  stageOverride?: InputMaybe<Stage>;
};
...
export type FindMeLinkPublishedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
  locales?: InputMaybe<Array<Locale>>;
};


export type FindMeLinkScheduledInArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
...
export type FindMeLinkUpdatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
  locales?: InputMaybe<Array<Locale>>;
};

export type FindMeLinkConnectInput = {
  /** Allow to specify document position in list of connected documents, will default to appending at end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Document to connect */
...
/** A connection to a list of items. */
export type FindMeLinkConnection = {
  __typename?: 'FindMeLinkConnection';
  aggregate: Aggregate;
  /** A list of edges. */
  edges: Array<FindMeLinkEdge>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};

export type FindMeLinkCreateInput = {
  createdAt?: InputMaybe<Scalars['DateTime']>;
  href: Scalars['String'];
  title: Scalars['String'];
  updatedAt?: InputMaybe<Scalars['DateTime']>;
...
export type FindMeLinkCreateManyInlineInput = {
  /** Connect multiple existing FindMeLink documents */
  connect?: InputMaybe<Array<FindMeLinkWhereUniqueInput>>;
  /** Create and connect multiple existing FindMeLink documents */
  create?: InputMaybe<Array<FindMeLinkCreateInput>>;
};

export type FindMeLinkCreateOneInlineInput = {
  /** Connect one existing FindMeLink document */
  connect?: InputMaybe<FindMeLinkWhereUniqueInput>;
  /** Create and connect one FindMeLink document */
  create?: InputMaybe<FindMeLinkCreateInput>;
};

/** An edge in a connection. */
export type FindMeLinkEdge = {
  __typename?: 'FindMeLinkEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String'];
  /** The item at the end of the edge. */
  node: FindMeLink;
...
/** Identifies documents */
export type FindMeLinkManyWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<FindMeLinkWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<FindMeLinkWhereInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<FindMeLinkWhereInput>>;
  /** Contains search across all appropriate fields. */
  _search?: InputMaybe<Scalars['String']>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  ...
  createdAt_not_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']>>>;
  createdBy?: InputMaybe<UserWhereInput>;
  documentInStages_every?: InputMaybe<FindMeLinkWhereStageInput>;
  documentInStages_none?: InputMaybe<FindMeLinkWhereStageInput>;
  documentInStages_some?: InputMaybe<FindMeLinkWhereStageInput>;
...
export enum FindMeLinkOrderByInput {
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
  HrefAsc = 'href_ASC',
  HrefDesc = 'href_DESC',
...
export type FindMeLinkUpdateInput = {
  href?: InputMaybe<Scalars['String']>;
  title?: InputMaybe<Scalars['String']>;
};

export type FindMeLinkUpdateManyInlineInput = {
  /** Connect multiple existing FindMeLink documents */
  connect?: InputMaybe<Array<FindMeLinkConnectInput>>;
  /** Create and connect multiple FindMeLink documents */
  create?: InputMaybe<Array<FindMeLinkCreateInput>>;
  /** Delete multiple FindMeLink documents */
  delete?: InputMaybe<Array<FindMeLinkWhereUniqueInput>>;
  /** Disconnect multiple FindMeLink documents */
  disconnect?: InputMaybe<Array<FindMeLinkWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing FindMeLink documents */
  set?: InputMaybe<Array<FindMeLinkWhereUniqueInput>>;
  /** Update multiple FindMeLink documents */
  update?: InputMaybe<Array<FindMeLinkUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple FindMeLink documents */
  upsert?: InputMaybe<Array<FindMeLinkUpsertWithNestedWhereUniqueInput>>;
};

export type FindMeLinkUpdateManyInput = {
  href?: InputMaybe<Scalars['String']>;
  title?: InputMaybe<Scalars['String']>;
};

export type FindMeLinkUpdateManyWithNestedWhereInput = {
  /** Update many input */
  data: FindMeLinkUpdateManyInput;
  /** Document search */
  where: FindMeLinkWhereInput;
};

export type FindMeLinkUpdateOneInlineInput = {
  /** Connect existing FindMeLink document */
  connect?: InputMaybe<FindMeLinkWhereUniqueInput>;
  /** Create and connect one FindMeLink document */
  create?: InputMaybe<FindMeLinkCreateInput>;
  /** Delete currently connected FindMeLink document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected FindMeLink document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
  /** Update single FindMeLink document */
  update?: InputMaybe<FindMeLinkUpdateWithNestedWhereUniqueInput>;
  /** Upsert single FindMeLink document */
  upsert?: InputMaybe<FindMeLinkUpsertWithNestedWhereUniqueInput>;
};

export type FindMeLinkUpdateWithNestedWhereUniqueInput = {
  /** Document to update */
...
export type FindMeLinkUpsertInput = {
  /** Create document if it didn't exist */
  create: FindMeLinkCreateInput;
  /** Update document if it exists */
  update: FindMeLinkUpdateInput;
};

export type FindMeLinkUpsertWithNestedWhereUniqueInput = {
  /** Upsert data */
  data: FindMeLinkUpsertInput;
  /** Unique document search */
  where: FindMeLinkWhereUniqueInput;
};

/** This contains a set of filters that can be used to compare values internally */
export type FindMeLinkWhereComparatorInput = {
  /** This field can be used to request to check if the entry is outdated by internal comparison */
  outdated_to?: InputMaybe<Scalars['Boolean']>;
};

/** Identifies documents */
export type FindMeLinkWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<FindMeLinkWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<FindMeLinkWhereInput>>;
...
/** The document in stages filter allows specifying a stage entry to cross compare the same document between different stages */
export type FindMeLinkWhereStageInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<FindMeLinkWhereStageInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<FindMeLinkWhereStageInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<FindMeLinkWhereStageInput>>;
  /** This field contains fields which can be set as true or false to specify an internal comparison */
  compareWithParent?: InputMaybe<FindMeLinkWhereComparatorInput>;
  /** Specify the stage to compare with */
  stage?: InputMaybe<Stage>;
};

/** References FindMeLink record uniquely */
export type FindMeLinkWhereUniqueInput = {
  id?: InputMaybe<Scalars['ID']>;
};
...
export type IconManyWhereInput = {
  ...
  /** All values that are contained in given list. */
  name_in?: InputMaybe<Array<InputMaybe<IconName>>>;
  /** All values that are not equal to given value. */
  name_not?: InputMaybe<IconName>;
  /** All values that are not contained in given list. */
  name_not_in?: InputMaybe<Array<InputMaybe<IconName>>>;
...
export type IconParent = Contact;
...
export type Mutation = {
  ...
  /**
   * Delete many FindMeLink documents
   * @deprecated Please use the new paginated many mutation (deleteManyFindMeLinksConnection)
   */
  deleteManyFindMeLinks: BatchPayload;
   ...
   * @deprecated Please use the new paginated many mutation (publishManyFindMeLinksConnection)
   */
  publishManyFindMeLinks: BatchPayload;
  /** Publish many FindMeLink documents */
  ...
  /**
   * Unpublish many FindMeLink documents
   * @deprecated Please use the new paginated many mutation (unpublishManyFindMeLinksConnection)
   */
  unpublishManyFindMeLinks: BatchPayload;
  ...
  /**
   * Update many findMeLinks
   * @deprecated Please use the new paginated many mutation (updateManyFindMeLinksConnection)
   */
  updateManyFindMeLinks: BatchPayload;
...
export type MutationCreateFindMeLinkArgs = {
  data: FindMeLinkCreateInput;
};
...
export type MutationDeleteManyFindMeLinksArgs = {
  where?: InputMaybe<FindMeLinkManyWhereInput>;
};


export type MutationDeleteManyFindMeLinksConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type MutationPublishManyFindMeLinksArgs = {
  to?: Array<Stage>;
  where?: InputMaybe<FindMeLinkManyWhereInput>;
};


export type MutationPublishManyFindMeLinksConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  from?: InputMaybe<Stage>;
...
export type MutationSchedulePublishFindMeLinkArgs = {
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  to?: Array<Stage>;
  where: FindMeLinkWhereUniqueInput;
...
export type MutationScheduleUnpublishFindMeLinkArgs = {
  from?: Array<Stage>;
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  where: FindMeLinkWhereUniqueInput;
...
export type MutationUnpublishManyFindMeLinksArgs = {
  from?: Array<Stage>;
  where?: InputMaybe<FindMeLinkManyWhereInput>;
};


export type MutationUnpublishManyFindMeLinksConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  from?: Array<Stage>;
...
export type MutationUpdateManyFindMeLinksArgs = {
  data: FindMeLinkUpdateManyInput;
  where?: InputMaybe<FindMeLinkManyWhereInput>;
};


export type MutationUpdateManyFindMeLinksConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  data: FindMeLinkUpdateManyInput;
  first?: InputMaybe<Scalars['Int']>;
...
export type ProjectCreateInput = {
  ...
  name: Scalars['String'];
  tags?: InputMaybe<Array<ProjectTag>>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
};
...
export type ProjectManyWhereInput = {
  ...
  tags_contains_all?: InputMaybe<Array<ProjectTag>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  tags_contains_none?: InputMaybe<Array<ProjectTag>>;
  /** Matches if the field array contains at least one item provided to the filter */
  tags_contains_some?: InputMaybe<Array<ProjectTag>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  tags_not?: InputMaybe<Array<ProjectTag>>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  updatedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type Query = {
  ...
  /** Retrieve a single findMeLink */
  findMeLink?: Maybe<FindMeLink>;
  /** Retrieve document version */
  findMeLinkVersion?: Maybe<DocumentVersion>;
  /** Retrieve multiple findMeLinks */
...
export type QueryFindMeLinkArgs = {
  locales?: Array<Locale>;
  stage?: Stage;
  where: FindMeLinkWhereUniqueInput;
};
...
export type QueryFindMeLinkVersionArgs = {
  where: VersionWhereInput;
};


export type QueryFindMeLinksArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  locales?: Array<Locale>;
  orderBy?: InputMaybe<FindMeLinkOrderByInput>;
  skip?: InputMaybe<Scalars['Int']>;
  stage?: Stage;
...
export type QueryFindMeLinksConnectionArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
